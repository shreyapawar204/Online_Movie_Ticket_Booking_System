<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginForm.aspx.cs" Inherits="MajorProject.LoginForm" %>
<!DOCTYPE html>
...
<body>
    ...
    <div class="login-container">
        ...
        <asp:Button ID="Button1" runat="server" Text="Login" CssClass="login-btn" OnClick="Button1_Click1" />
        
        <div class="signup-link">
            Not a member? <a href="Registrationpage.aspx">Sign up</a>
        </div>
    </div>
    </form>
</body>
